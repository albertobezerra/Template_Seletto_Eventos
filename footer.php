<div class="footer">
	<div class="container">
		...
		<img src="<?php bloginfo( 'template_directory' ); ?>/assets/images/logobranco.png" class="logo-footer">

			<div class="direitos">Direitos autorais reservados | 2006-2017</div>
			<div class="endereco">Rua Porto Alegre, 115 - Nossa Senhora das Dores - Caruaru - PE <br>criacao@selettoeventos.com.br | (81) 99448-2541 | 99821-7993
			</div>
	</div>
</div>
